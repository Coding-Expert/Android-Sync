...
import jagerfield.mobilecontactslibrary.ContactFields.CompanyField;
...
import jagerfield.mobilecontactslibrary.ContactFields.IMField;
...
public class FieldsContainer
{
    ...
    private void Instantiate() {
        ...
        contactFieldsList.add(companyField);
        contactFieldsList.add(imField);
    }
    ...
    public interface IFieldContainer extends NameField.INameField, NumberField.INumberField, EmailField.IEmailField, WebsiteField.IWebsiteField,
            AddressField.IAddressField, NoteField.INoteField, EventField.IEventField, NickNameField.INickNameField, CompanyField.ICompanyField, IMField.IIMField
    {
