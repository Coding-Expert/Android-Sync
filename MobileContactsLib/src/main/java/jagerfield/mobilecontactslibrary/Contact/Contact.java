...
public class Contact implements FieldsContainer.IFieldContainer
{
    ...
    public String getNamePrefix() {
        ...
        if(fields.getNameField().getNamePrefix()==null){return "";}

        return fields.getNameField().getNamePrefix();
    }
    ...
    public String getMiddleName() {
        ...
        if(fields.getNameField().getMiddleName()==null){return "";}

        return fields.getNameField().getMiddleName();
    }
    ...
    public String getNameSuffix() {
        ...
        if(fields.getNameField().getNameSuffix()==null){return "";}

        return fields.getNameField().getNameSuffix();
    }
    ...
    public String getCompanyName() {
        ...
        if (fields.getCompanyField()==null){return "";}
        String name = fields.getCompanyField().getCompanyName();
        if(name == null){
            return "";
        }
        else{
    ...
    public String getCompanyTitle() {
        ...
        if (fields.getCompanyField()==null){return "";}
        String title = fields.getCompanyField().getCompanyTitle();
        if(title == null){
            return "";
        }
        else {
    ...
    public LinkedList<IMContainer> getIms() {
        return fields.getImField().getIms();
    }
}
